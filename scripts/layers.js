...
function addLegEconomy() {
  ...
  var row = table.insertRow(0);
  row.outerHTML = `
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Сільське господарство</td><td><input value="lu_farmland" type="checkbox" id="lu_farmland_box" checked></td></tr>
