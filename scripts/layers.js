...
function addLegEconomy() {
  ...
  var row = table.insertRow(0);
  row.outerHTML = `
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Виробничі територіх</td><td><input value="lu_industrial" type="checkbox" id="lu_industrial_box" checked></td></tr>
