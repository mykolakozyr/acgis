...
function addLegEconomy() {
  ...
  var row = table.insertRow(0);
  row.outerHTML = `
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Промислові підприємства</td><td><input value="lu_industrial" type="checkbox" id="lu_industrial_box" checked></td></tr>
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Фермерські угіддя</td><td><input value="lu_farmyard" type="checkbox" id="lu_farmyard_box" checked></td></tr>
  ...
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Рілля</td><td><input value="lu_farmland" type="checkbox" id="lu_farmland_box" checked></td></tr>
  <tr><td class="index">500</td><td class="leg_clip"><img src="imgs/temp.png"></td><td class="leg_layer_name">Закинуті території</td><td><input value="lu_brownfield" type="checkbox" id="lu_brownfield_box" checked></td></tr>
  `;
};
