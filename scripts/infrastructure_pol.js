...
var in_bank = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:in_bank',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_bank'
});
var in_cafe = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_cafe'
});
var in_clothes = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_clothes'
});
var in_community_centre = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_community_centre'
});
var in_doctors = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_doctors'
});
var in_dormitory = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_dormitory'
});
var in_electronics = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_electronics'
});
var in_events_venue = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_events_venue'
});
var in_funeral_directors = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_funeral_directors'
});
var in_furniture = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_furniture'
});
var in_grocery = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_grocery'
});
var in_health = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_health'
});
var in_homeshop = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_homeshop'
});
var in_hospital = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_hospital'
});
var in_hotel = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_hotel'
});
var in_hypermarket = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_hypermarket'
});
var in_kids = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_kids'
});
var in_kindergarten = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_kindergarten'
});
var in_library = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_library'
});
var in_market = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_market'
});
var in_minimarket = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_minimarket'
});
var in_museum = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_museum'
});
var in_orthodox = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_orthodox'
});
var in_park = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_park'
});
var in_pharmacy = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_pharmacy'
});
var in_preschool = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_preschool'
});
var in_resort = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_resort'
});
var in_sacral = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_sacral'
});
var in_school = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_school'
});
var in_school_notfull = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_school_notfull'
});
var in_schoolsport = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_schoolsport'
});
var in_serv_org = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_serv_org'
});
var in_shop = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_shop'
});
var in_shop_build = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_shop_build'
});
var in_special = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_special'
});
var in_sport = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_sport'
});
var in_sport_general = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
  pane: 'indexPanein_sport_general'
});
var in_stadium = L.tileLayer.wms('http://localhost:8080/geoserver/otg/wms', {
  layers: 'otg:',
  format: 'image/png',
  transparent: true,
